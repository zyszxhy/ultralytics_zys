...
class BaseModel_m(nn.Module):
    ...
    def predict(self, x_rgb, x_ir, profile=False, visualize=False, augment=False):
        """
        ...
        return self._predict_once(x_rgb, x_ir, profile, visualize)

    def _predict_once(self, x_rgb, x_ir, profile=False, visualize=False):
        """
        Perform a forward pass through the network.
    ...
    def load(self, weights, verbose=True):
        ...
        Args:
            weights (str): The path of pre-trained weights to be loaded.
...
class RTDETRDetectionModel_m(DetectionModel_m):
    ...
    def predict(self, x_rgb, x_ir, profile=False, visualize=False, batch=None, augment=False):
        """
        Perform a forward pass through the network.
