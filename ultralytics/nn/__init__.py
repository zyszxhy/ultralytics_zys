...
from .tasks_m import (BaseModel_m, ClassificationModel_m, DetectionModel_m, SegmentationModel_m)
...
__all__ = ('attempt_load_one_weight', 'attempt_load_weights', 'parse_model', 'yaml_model_load', 'guess_model_task',
           ...
           'BaseModel', 'BaseModel_m', 'ClassificationModel_m', 'DetectionModel_m', 'SegmentationModel_m')
