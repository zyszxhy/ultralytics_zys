...
from ultralytics.data import YOLODataset_m
from ultralytics.data.augment_m import Compose, Format_m, v8_transforms_m
...
class RTDETRDataset_m(YOLODataset_m):
    ...
    def build_transforms(self, hyp=None):
        ...
        if self.augment:
            ...
            transforms = v8_transforms_m(self, self.imgsz, hyp, stretch=True)
        else:
...
class RTDETRValidator_m(DetectionValidator_m):
    """
