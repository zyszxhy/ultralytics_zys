    ...
    def update_metrics(self, preds, batch):
        ...
        for si, pred in enumerate(preds):
            ...
            if self.args.single_cls:
                pred[:, 5] = 0
            predn = pred.clone()
            predn[..., [0, 2]] *= shape[1] / self.args.imgsz_val  # native-space pred
            predn[..., [1, 3]] *= shape[0] / self.args.imgsz_val  # native-space pred
